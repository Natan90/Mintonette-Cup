...
exports.validatePrestataireById = async (req, res) => {
  ...
  try {
    const result =
      await adminPrestataireService.validatePrestataireById(id_presta);
...
exports.refuserPrestataireById = async (req, res) => {
  ...
  try {
    const result =
      await adminPrestataireService.refuserPrestataireById(id_presta);
...
exports.deletePrestataireById = async (req, res) => {
  ...
  try {
    const result =
      await adminPrestataireService.deletePrestataireById(id_presta);
    return res.status(201).json(result);
  } catch (err) {
    console.error(err);
    const status = err.status || 500;
...
exports.assignZoneById = async (req, res) => {
  ...
  try {
    const result = await adminPrestataireService.assignZoneById(
      id_zone,
      id_prestataire,
    );
    return res.status(201).json(result);
