...
router.get("/message/:id/select", authMiddleware.authenticateToken, reception_boxMiddleware.validateGetMessageByIdMessage, reception_boxController.getMessagesByIdMessage);
