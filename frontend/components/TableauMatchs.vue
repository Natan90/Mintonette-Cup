...
<style>
:root {
    /* Coordonnées à laquelle commence les barres */
    --verticalVal: 30px;
    --horizontalVal: -50px;
...
.bracket_left .round8 .match_group::before { right: var(--horizontalVal); }
.bracket_right .round8 .match_group::before { left: var(--horizontalVal); }
